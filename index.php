...
<body>
	...
	<div id="html_usuario">
		<?php
			/*if(!empty($_SESSION)){
				...
				echo '<div class="row d-flex justify-content-evenly" id="menu_padrao">
							<nav class="bg_preto">
								<div class="col-4">
									<img src="imagens/logo.png" width="150px" height="150px">
	...
	<!--CARROSSEL-->
	<div id="carouselExampleCaptions" class="shadow-lg p-2 carousel slide " data-bs-ride="carousel">
	  ...
	  <div class="carousel-inner">
		<div class="carousel-item active">
		  <img src="logo/capa1.jpg" class="d-block w-100" alt="...">
	...
	<!--<div class="my-4 mx-4 row">
		<div class="card mx-2 col" style="width: 18rem;">
		  <img src="imagens/capa1.jpg" class="card-img-top" alt="...">
		  <div class="card-body">
		...
		<div class="card col mx-2" style="width: 18rem;">
		  <img src="imagens/capa2.jpg" class="card-img-top" alt="...">
		  <div class="card-body">
			<h5 class="card-title">Projeto Y</h5>
			<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
			<a href="html/ex_proj.html" class="btn btn-primary">Saiba mais</a>
		  </div>
		</div>
		<div class="card col mx-2" style="width: 18rem;">
		  <img src="imagens/capa3.jpg" class="card-img-top" alt="...">
		  <div class="card-body">
			<h5 class="card-title">Projeto Z</h5>
			<p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
			<a href="html/ex_proj.html" class="btn btn-primary">Saiba mais</a>
		  </div>
		</div>
